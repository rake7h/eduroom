      ...
      <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    <li role="navigation"> <a href=""><i class="fa fa-rss" aria-hidden="true"></i>  Activity feed</a></li>
                    ...
                    <li role="navigation" class="active"><a href=""><i class="fa fa-calendar" aria-hidden="true"></i> Calendar</a>
