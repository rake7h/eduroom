...
<div id="a1" class="hidden">
   <div class="popover-body">
       ...
       <div class="row">
           <div class="col-md-2" style="border:dotted;">
               <div style="width:64px; height:64px;" >
               <a href="app/guidecp.php" style="width:44px; height:44px; magin:2px;"><i class="fa fa-blind fa-2x" aria-hidden="true"></i>
           ...
           <div class="col-md-2" style="border:dotted;">
               <div style="width:64px; height:64px;" >
               <a href="app/headcp.php" style="width:44px; height:44px; magin:2px;"><i class="fa fa-blind fa-2x" aria-hidden="true"></i>
                   <p><span style="text-align:center;">Head Dashboard</span><p>
                   </a>
               </div>
            </div>
