           ...
           <!--TABS for hod-->
            <div class="container">
                <ul class="nav nav-tabs" style=" margin-bottom: 10px;">
                    <li><a href="../index.php?college=<?php echo $_SESSION['college_profile_id'];?>">Projects</a></li>
                    <li><a href="../student/student.php?college=<?php echo $_SESSION['college_profile_id']; ?>">Student & Alumni</a></li>
                    <li class="active"><a href="../activity/activity.php?college=<?php echo $_SESSION['college_profile_id']; ?>">Activity</a></li>
