           ...
           <!--TABS for hod-->
            <div class="container">
                <ul class="nav nav-tabs" style=" margin-bottom: 10px;">
                    <li><a href="../index.php?college=<?echo $_SESSION['college_profile_id'];?>">Projects</a></li>
                    <li><a href="../student/student.php?college=<?echo $_SESSION['college_profile_id'];?>">Student & Alumni</a></li>
                    <li><a href="../activity/activity.php?college=<?echo $_SESSION['college_profile_id'];?>">Activity</a></li>
            ...
            <div class="container">
                <ul class="nav nav-tabs" style=" margin-bottom: 10px;">
                    <li><a href="../../index.php?college=<?echo $_SESSION['college_profile_id'];?>">Projects</a></li>
                    <li><a href="../student/studet.php?college=<?echo $_SESSION['college_profile_id'];?>" >Student & Alumni</a></li>
                    <li><a href="../activity/activity.php?college=<?echo $_SESSION['college_profile_id'];?>">Members</a></li>
                </ul>
            </div>            
            <?php } 
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            <!-- Main menu -->
                            <li><a href="settings.php?college=<?echo $_SESSION['college_profile_id'];?>"><i class="glyphicon glyphicon-home"></i> Options</a></li>
                            <li class="current"><a href=""><i class="glyphicon glyphicon-calendar"></i> Members</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Project guides</h3> </div>
                        <div class="panel-body"> 
                        
                                <?php include '../../../institutes/institute_member.php'; ?>
