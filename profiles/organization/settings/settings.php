    ...
    <head>
           ...
           <!--TABS for hod-->
            ...
            <div class="container">
                <ul class="nav nav-tabs" style=" margin-bottom: 10px;">
                    ...
                    <li><a href="../member/member.php?college=<?echo $_SESSION['college_profile_id'];?>">Members</a></li>
                </ul>
            </div>            
            <?php } 
     ...
     <div>
                ...
                <div class="col-md-2">
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            ...
                            <li><a href="member.php?college=<? echo $_SESSION['college_profile_id']; ?>"><i class="glyphicon glyphicon-calendar"></i> Members</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Options</h3> </div>
        ...
        <!--Page footer section-->
            ...
            <?php echo $_SESSION['college_profile_id']; ?>
